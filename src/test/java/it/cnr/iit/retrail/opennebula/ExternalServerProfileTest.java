...
public class ExternalServerProfileTest extends TestCase {

    static final org.slf4j.Logger log = LoggerFactory.getLogger(ExternalServerProfileTest.class);
    static final String pepUrlString = "http://146.48.99.95:9081";
    static final String pdpUrlString = "http://146.48.99.87:9080";
    static final String pipUrlString = "http://146.48.99.87:9082";
    ...
    public ExternalServerProfileTest(String testName) {
        super(testName);
    }
